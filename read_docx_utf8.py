...
with open("2.4_text.txt", "w", encoding="utf-8") as f:
    f.write(get_docx_text(r"d:\PTTK Hệ Thống\PROJECT\2.4.docx"))

with open("chuong1_2_text.txt", "w", encoding="utf-8") as f:
    f.write(get_docx_text(r"d:\PTTK Hệ Thống\PROJECT\CHƯƠNG 1 + 2.docx"))

print("Done writing text files.")
